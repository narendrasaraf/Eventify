...
import { ShieldCheck, Video, BarChart3 } from 'lucide-react';
        ...
        {user ? (
          <div className="flex flex-col items-center justify-center gap-4">
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white flex items-center gap-3 text-lg font-black px-12 py-4 rounded-2xl transition-all shadow-xl shadow-indigo-600/20 active:scale-95 hover:scale-[1.02] duration-200"
            >
              Go to Dashboard
            </button>
          </div>
